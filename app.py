...
def student_edit(student_id):
    if request.method == 'GET':
        ...
        if student:
            ...
            student.email = request.form['email']  # added email update
            student.major_id = request.form['major_id']
            student.birth_date = dt.strptime(request.form['birth_date'], '%Y-%m-%d')  # fixed incorrect name birthdate -> birth_date
